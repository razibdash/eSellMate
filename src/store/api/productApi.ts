...
export const productApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    updateCategory: builder.mutation<
      Category,
      { id: string | number; body: Partial<CategoryPayload> }
    >({
      query: ({ id, body }) => ({
        url: `/categories/${id}`,
        method: "PUT",
    ...
    createProduct: builder.mutation<Product, ProductPayload>({
      ...
      invalidatesTags: ["Product", "Report", "Stock"],
    }),
    updateProduct: builder.mutation<
      Product,
      { id: string | number; body: Partial<ProductPayload> }
    >({
      query: ({ id, body }) => ({
        url: `/products/${id}`,
        method: "PUT",
    ...
    deleteProduct: builder.mutation<Product, string | number>({
